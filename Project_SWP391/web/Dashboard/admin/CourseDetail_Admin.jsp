    ...
    <body>
        ...
        <jsp:include page="../../components/header.jsp"></jsp:include>
                ...
                <div class="row content " style="display: contents">
                    <div class="col-sm-2 col-md-2 sidenav hidden-xs " style="background-color: white;border-radius: 15px;padding: 0px" >
                        ...
                        <ul class="nav flex-column">
                            ...
                            <li class="nav-item">
                                <a class="nav-link" href="ShowLesson?courseId=${course.course_id}&action=${action}">Lesson List</a>
                            </li>
                                                    ...
                                                    <div class="modal-dialog">
                                                        <div class="modal-content">
                                                            ...
                                                            <div class="modal-body">
                                                                <form action="ShowInformationCourse?dimenId=${Dimen.dimension_id}&action=addDimesion&courseId=${course.course_id}" method="post">
            ...
            <div class="form-group">
                ...
                <input type="text" class="form-control" name="dimensionName">
            </div>
            <div class="form-group">
                                ...
                                <div class="col-md-9">
                                    <div class=form-group " style="margin-bottom: 20px;" >
                                        ...
                                        <c:if test="${action eq 'edit'}">
                                            <input type="text" name="courseName" class="form-control" value="${course.course_name}" <c:if test="${userRole.role_id!=1}">readonly=""</c:if>>
                                        </c:if>
                                    </div>
                                    <div class="form-group" style="margin-bottom: 20px;display: flex;align-items: center">
                                        ...
                                        <c:if test="${action eq 'edit'}">
                                            <select class="form-select" id="cateID" name="cateID">
                                                ...
                                                <c:forEach var="Cate" items="${listCate}">
                                                    <option value="${Cate.category_id}" <c:if test="${Cate.category_id eq course.category_id}">selected</c:if> <c:if test="${userRole.role_id!=1}">disabled=""</c:if>>${Cate.category_name}</option>
                                                </c:forEach>
                                            </select>
                                        </c:if>
                                    </div>
                                    ...
                                    <div class="form-group" style="margin-bottom: 20px">
                                        <div class="form-label">
                                            <label for="expert col-md-2" >Expert<c:if test="${userRole.role_id!=1}">: ${acc.user_name}</c:if></label>
                                            </div>
                                    ...
                                    <div class="form-group" style="margin-bottom: 20px">
                                        ...
                                        <textarea class="form-control" name="description" id="description" style="height:  150px;" required <c:if test="${userRole.role_id!=1}">readonly=""</c:if>>${course.description}</textarea>
